...
```{r echo=FALSE, fig.cap=" histogram of number of comments",warning=FALSE}
#plot histogram of number of comments
...
```{r echo=FALSE,fig.cap="Three variables vs log(number of comment)"}
p1<-ggplot(data = app1)+
  aes(as.numeric(user_rating),log(rating_count_tot))+
  geom_point(aes(color = prime_genre),alpha = 0.1)+
  labs(x="user rating",y="log(number of comment)")+
...
p2<-ggplot(data = app1)+
  ...
  geom_point(aes(color = prime_genre),alpha = 0.1)+
  labs(x="log(Number of supporting languages)",y="log(number of comment)")+
  geom_smooth(aes(color = prime_genre),method = "lm",se=F,formula = y~x)+
  theme(legend.position = "none")
...
p3<- ggplot(data = app1)+
  ...
  geom_point(aes(color = prime_genre),alpha = 0.1)+
  labs(x="price",y="log(number of comment)")+
  geom_smooth(aes(color = prime_genre),method = "lm",se=F,formula = y~x)+
  theme(legend.position = "none")
